...
message(2).pType = 0;
message(2).period = 20;
message(2).deadline = 20;
message(2).dynPeriod = 0;
message(2).sourceMasterNumber = 1;
message(2).source = 1;
message(2).dest = 3;
message(2).destMasterNumber = 1;
message(2).SwitchInRout = 0;
message(2).SwitchPort = 0;
...
message(4).pType = 0;
message(4).period = 12;
message(4).deadline = 12;
message(4).dynPeriod = 0;
message(4).sourceMasterNumber = 1;
message(4).source = 3;
message(4).dest = 1;
message(4).destMasterNumber = 1;
message(4).SwitchInRout = 0;
message(4).SwitchPort = 0;
...
message(5).pType = 0;
message(5).period = 50;
message(5).deadline = 50;
message(5).dynPeriod = 0;

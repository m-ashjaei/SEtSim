...
for m = 1:master_number
    ...
    master(m).tm_size = 0.01;          %TM size which is 10ms
    ...
    master(m).ap_size = 0.01;          %aperiodic signal size which is 10ms
...
for i = 1:slave_number
    ...
    slave(i).ap_size = 0.01;            %aperiodic signal size which is 10ms
    ...
    slave(i).tm_size = 0.01;            %TM size is 10ms
